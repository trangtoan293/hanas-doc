- review lại toàn bộ sản phẩm hanas data platform
    ...
    - review lại các cấu phần của quan trọng của hanas data platform
        - liệt kê những cấu phần đang sử dụng và tài liệu quan trọng để sử dụng
        - nêu rõ chức năng của từng service trong hanas
        - làm tài liệu chi tiết cho từng service : bao gồm cài đặt, chức năng , hướng dẫn sử dụng
        - làm tài liệu gốc để xây dựng bộ tài liệu chuẩn chỉnh
